...
- **Interactive Chessboard** — Custom CSS grid board with unicode pieces, drag-and-drop and click-click input
...
- **LLM Integration** — Your SillyTavern character reacts to the game in character
- **Game State Persistence** — Games survive page refresh and chat switches
- **Draggable Panel** — Floating chess panel that doesn't break the chat layout
...
3. Make moves by clicking or dragging pieces
...
- Game context is injected into the LLM prompt so the character can react appropriately
